...
def train_one_epoch(
    ...
    num_batches_per_epoch = len(loader) // args.iters_to_accum + (1 if len(loader) % args.iters_to_accum > 0 else 0)
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        num_trains += input.size(0)
        if need_step and (batch_idx // args.iters_to_accum) % args.log_interval == 0:
            ...
            if utils.is_primary(args):
                _logger.info(
                    ...
                    'Data: {data_time.val:.3f} ({data_time.avg:.3f})'.format(
                        ...
                        rate=num_trains * args.world_size / batch_time_m.val,
                        rate_avg=num_trains * args.world_size / batch_time_m.avg,
                        lr=lr,
